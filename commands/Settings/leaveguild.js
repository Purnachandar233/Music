...
module.exports = {
  ...
  run: async (client, message, args, guildData, player, prefix) => {
    if (!config.ownerIDS.includes(message.author.id)) {
      ...
      .setDescription(`${emoji.msg.ERROR} | You are not allowed to run this command! Only Owners is allowed to run this command`)
    ...
    try {
      ...
      try {
        ...
        console.error(error);
        return message.channel.send({content: "I Couldn't leave the Guild!"});
      } 
    } catch (e) {
