  ...
  run: async (client, message, args, guildData, player, prefix) => {
    try{
      ...
      if(!channel) {
        ...
        return message.reply ({embeds: [tot], allowedMentions: { repliedUser: false }})
      }
      ...
      if(player) {
        ...
        .setColor(ee.wrongcolor)
        .setDescription(`${emoji.msg.ERROR} | I am already connected in Vc`)
        return message.reply ({embeds: [mm], allowedMentions: { repliedUser: false }});
      }
      //create the player
      ...
      if (player.state !== "CONNECTED") { 
        ...
        .setColor(ee.wrongcolor)
        .setDescription(`${emoji.msg.ERROR} | I am already connected in vc`)
        return message.reply ({embeds: [oop], allowedMentions: { repliedUser: false }});
      }
    } catch (e) {
