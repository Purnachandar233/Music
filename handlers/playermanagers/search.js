...
async function search(client, message, args, type) {
    ...
    try {
      ...
      return message.reply({embeds: [errrr], allowedMentions: { repliedUser: false }});
    }
    ...
    .addComponents(
        ...
        .setPlaceholder('SELECT FROM ABOVE MENU SONG!')
        .addOptions([
            {
    ...
    message.reply({ embeds: [ssss], components: [row], allowedMentions: { repliedUser: false }}).then(selectMessage => {
        try {
            ...
            collector.on('collect', async i => {
                if (i.customId === 'searchlol') {
                    ...
                    if (i.user.id !== message.author.id) {
                        ...
                        .setTitle(`${emoji.msg.ERROR}| Error`)
                        .setColor(ee.color)
                    ...
                    if (!res.tracks[0]) {
                        ...
                        .setColor(ee.wrongcolor)
                        .setDescription(`${emoji.msg.ERROR} No Song Was Found Try Again: **${search.substr(0, 256 - 3)}**`)
        ...
        .setDescription(`<a:Playing:915811459634692106> **[${res.tracks[0].title}](${res.tracks[0].uri})**`)
            ...
            .setDescription(`${emoji.msg.ERROR} | There Was a Error Found So Try Again or Contact Developer`)
            .setColor(ee.wrongcolor)
